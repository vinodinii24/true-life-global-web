          ...
          {insightsData.map((insight, index) => {
            ...
            return (
              <motion.article
                ...
                className="group relative bg-slate border border-slate-200 p-8 rounded-3xl shadow-[0_8px_30px_rgba(15,23,42,0.01)] flex flex-col justify-between transition-all duration-300 hover:border-[#1D4ED8] hover:shadow-[0_20px_50px_rgba(15,23,42,0.03)]"
              >
                <div>
                  ...
                  <h3 className="font-display text-lg font-bold text-[#0F172A] mb-3 tracking-tight transition-colors duration-200">
                    {insight.title}
                  </h3>
